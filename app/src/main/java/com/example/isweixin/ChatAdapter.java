        ...
        if (convertView == null) {
            switch (type) {
                ...
                case VALUE_RIGHT_TEXT:
                    ...
                    holderRightText.ivRightIcon = (ImageView) convertView.findViewById(R.id.iv_icon);
                    holderRightText.btnRightText = (Button) convertView.findViewById(R.id.btn_right_text);
                ...
                case VALUE_RIGHT_IMAGE:
                    ...
                    holderRightImg.ivRightIcon = (ImageView) convertView.findViewById(R.id.iv_icon);
                    holderRightImg.ivRightImage = (ImageView) convertView.findViewById(R.id.iv_right_image);
                ...
                case VALUE_RIGHT_AUDIO:
                    ...
                    holderRightAudio.ivRightIcon = (ImageView) convertView.findViewById(R.id.iv_icon);
                    holderRightAudio.btnRightAudio = (Button) convertView.findViewById(R.id.btn_right_audio);
                    holderRightAudio.tvRightAudioTime = (TextView) convertView.findViewById(R.id.tv_right_audio_time);
