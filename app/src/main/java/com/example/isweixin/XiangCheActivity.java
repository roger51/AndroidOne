...
import com.example.isweixin.TryRefreshableView.OnBottomListener;
import com.example.isweixin.TryRefreshableView.RefreshListener;
...
public class XiangCheActivity extends Activity implements ImageLoadCompleteListener {
    private static final int DOWNREFRESH = 1;
    private static final int UPREFRESH = 2;
    private int currentLoadCount = 0;
    private int totalDataCount = 0;
    protected static final String TAG = "XiangCheActivity";
    ...
    private void InitLayout() {
        ...
        waterfall_scroll.setOnScrollListener(new OnScrollListener() {
            ...
            public void onAutoScroll(int l, int t, int oldl, int oldt) {
                ...
                Log.d("XiangCheActivity", "scroll_height:" + scroll_height);
                    ...
                    if (t > 3 * scroll_height) {// 超过两屏幕后
                        ...
                        for (int k = 0; k < column_count; k++) {
                            ...
                            if (pin_mark[k].get(topIndex[k]) < t - 2
                                ...
                                Log.d("XiangCheActivity", "recycle,k:" + k
        ...
        if (task.getStatus() != Status.RUNNING) {
            if (currentLoadCount >= totalDataCount) {
                ...
                String url = "http://www.duitang.com/album/1733789/masn/p/"
                        + pageindex + "/24/";
                Log.d("XiangCheActivity", "current url:" + url);
                ContentTask task = new ContentTask(this);
                task.execute(url);
            }
        }
    ...
    public synchronized void onLoadComplete(Bitmap bitmap, DuitangInfo _info) {
        ...
        Log.d("XiangCheActivity", "w:" + w + ",h:" + h);
    ...
    private class ContentTask extends
        ...
        protected List<DuitangInfo> doInBackground(String... params) {
            List<DuitangInfo> duitangs = null;
            try {
                duitangs = parseNewsJSON(params[0]);
            } catch (IOException e) {
                e.printStackTrace();
            }
            return duitangs;
        ...
        public List<DuitangInfo> parseNewsJSON(String url) throws IOException {
            ...
            Log.d("XiangCheActivity", "json:" + json);
